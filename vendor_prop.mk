...
PRODUCT_VENDOR_PROPERTIES += \
    ...
    persist.log.tag.BufferQueueDump=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.BufferQueueProducer=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.SurfaceControl=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.GraphicBuffer=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.hwcomposer=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.netd=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.gralloc4=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MDP=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.PQ=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.GPUAUX=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.Profiler=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.GED=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.HWComposer=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.mali_config=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.lsc_nvram=$(VENDOR_LOG_LEVEL_I)
